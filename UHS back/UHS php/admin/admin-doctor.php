...
$duid=$_SESSION['duid'];
   //HOSPITAL 
   $hosData="SELECT `slno` FROM `hospital`";
  $resHos=mysqli_query($connection,$hosData);
//DOCTOR TABLE 
$docData="SELECT `slno` FROM `doctor`";
$resDoc=mysqli_query($connection,$docData);
//PATIENT 
$patData="SELECT `slno` FROM `patient`";
$respat=mysqli_query($connection,$patData);



//GET DOCTOR DATA
$SqlDoc="SELECT * FROM `doctor` WHERE `d_uid`='$duid'";
$DocDet=mysqli_query($connection,$SqlDoc);
$rowData=mysqli_fetch_assoc($DocDet);
$h_id=$rowData['h_uid'];
$SqlHos = "SELECT * FROM `hospital` WHERE `uid` = '$h_id'";
$resHdet=mysqli_query($connection,$SqlHos);
$rowHDat=mysqli_fetch_assoc($resHdet);
...
<div class="col-5 d-flex justify-content-end ">
 ...
 <i class="fa fa-envelope ms-2"><span class="ms-2 h6">uhs@mail.com</span></i>
    ...
    <!-- Company Branding -->
<div class="container-fluid  h-25 d-flex flex-column align-items-center" style="background-color: #fce6c2d0;">
...
<!-- Main Nav Bar -->
    ...
    <nav id="primary_nav" class="navbar navbar-expand-lg navbar-expand-md  navbar-dark " >
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-5">
              ...
              <li class="nav-item rounded-1">
                <a id="history_link" class="nav-link text-white" href="#" onmouseover="this.style.color='#1e038c'" onmouseout="this.style.color='white'""><i class="fas fa-history ms-4 me-3"></i>Treatment History</a>
              </li>
              <li id="patient_link" class="nav-item rounded-1">
                <a id="history_link" class="nav-link text-white" href="#" onmouseover="this.style.color='#1e038c'" onmouseout="this.style.color='white'""><i class="fas fa-list-check ms-4 me-3"></i>Patient Details</a>
              </li>
              <!-- <li class="nav-item  rounded-1">
                <a id="Prescribe_link" class="nav-link text-white " href="#" onmouseover="this.style.color='#1e038c'" onmouseout="this.style.color='white'"><i class="fas fa-file-prescription ms-4 me-3"></i>Prescribe</a>
              </li> -->
              <li class="nav-item  rounded-1">
...
<section id="dashboard" class="container-fluid ">
    ...
    <div class="row text-dark">
       ...
       <div class="col-12 d-flex justify-content-evenly mt-5 mb-3">
        <div id="card1" class="card mt-5 ms-5  mb-5" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <h1 class="text-center" >00<?php 
      
                
                $hosrow=mysqli_num_rows($resHos);   printf($hosrow);     
      ...
      $hosrow=mysqli_num_rows($resDoc);   printf($hosrow);     
      ...
      $hosrow=mysqli_num_rows($respat);   printf($hosrow);     
    ...
    <div class="col-12 text-dark text-center mb-5">
        <h1 style="
            ...
            text-underline-offset: 6px;">Welcome  to UHS Doctor Portal</h1>
    </div>

    <div class="col-6 text-dark d-flex justify-content-center mt-5">
      <div class="card-body ps-5 ms-4">
        <p class="card-text">
          <h2><i class="fa fa-id-card" style="color: #012155;" ></i> : <?php echo $duid; ?></h2>
          <h3><i class="fa fa-user" style="color: #012155;"></i> :  Dr. <?php  echo$rowData['firstname']."".$rowData['lastname'];  ?></h3>
          <h3><i class="fa fa-stethoscope" style="color: #012155;"></i> : <?php  echo$rowData['speciality'];  ?> 
          </h3>
         
          <h3><i class="fa fa-mars-and-venus" style="color: #012155;"></i> : <?php  echo$rowData['gender'];  ?>
          </h3>
          <h3><i class="fa fa-hospital" style="color: #012155;"></i> : <?php  echo$rowHDat['name']  ?>
          </h3>
        
          <h3> <i class="fa fa-phone" style="color: #012155;"></i> : <?php  echo$rowData['phone']  ?></h3>
          <h3> <i class="fa fa-envelope-circle-check" style="color: #012155;"></i> : <?php  echo$rowData['email']  ?></h3>
          <h3> <i class="fa fa-address-book" style="color: #012155;"></i> : <?php  echo$rowHDat['address']  ?></h3>
          <h3 class="ps-5" ><?php  echo$rowHDat['city'].", ".$rowHDat['state']; ?></h3>
        </p>
      </div>

    </div>
    <div class="col-6 text-dark pt-5 mt-5">
        <h3><?php  echo$rowData['firstname']  ?> ,</h3><p>Thank you for registering in our portal! We appreciate your trust in us and are delighted to have you on board. We hope you find our services useful and efficient. As you continue to use our portal, we wish you good health and happiness ahead. We understand the value of your time, and our team is committed to providing you with the best experience possible. Please do not hesitate to contact us if you have any questions or concerns. Once again, thank you for choosing us, and we look forward to serving you in the future.  
...
<h1 class="col-12 text-dark text-center underline mt-3 mb-5">Treatment History</h1>
...
<!-- 3)PATIENT HISTORY SECTION   -->
<section id="Patienthistory" class="container-fluid">

    <div class="row ps-4 pe-4">


<h1 class="col-12 text-dark text-center underline mt-3 mb-5">Patient History</h1>

<div class="col-12">
  <form action="./getPatient.php" method="get">
    <div class="input-group mb-3">
      <input type="email" class="form-control shadow" placeholder="Enter your email" aria-label="Email" aria-describedby="submit-button" name="emailPat">
...
?>
  ...
  <div class="container">
<form action="./postDatapat.php" method="post" class="d-flex justify-content-center flex-column" >
  <input type="text" class="form-control mb-4" placeholder="Enter Disease" name="disease">
  <input type="text" class="form-control mb-4" placeholder="Enter Medication" name="medication">
...
<script src="./js/page-shift.js"></script>
